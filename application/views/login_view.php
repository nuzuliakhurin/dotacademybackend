					...
					<div class="left">
						<div class="content">
							...
							<form class="form-auth-small" action="<?=base_url('index.php/login/cek_login'); ?>" method="post">
								...
								<input type="submit" class="btn btn-promary btn-lg btn-block" value="LOGIN">
								<div class="bottom">
									<span class="helper-text"><i class="fa fa-lock"></i> Belum memiliki akun? <a href="<?= base_url('index.php/daftar')?>">Daftar disini</a></span>
								</div>
							</form>
						</div>
					</div>
